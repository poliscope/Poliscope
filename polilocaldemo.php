  ...
  <div class="col-sm-4 well">
	...
	$conn = mysqli_connect('localhost','root','','poliscope');
        if(mysqli_connect_error())
        {
			...
			$sql="Select * from users as u inner join posts as p on p.const_category='local' and p.const=(Select const from posts where politician_id='$_SESSION[pol]') and u.user_id=p.user_id and p.user_id!=$_SESSION[user]";
    ...
    <!--<img src="bird.jpg"  alt="Avatar">   <h>User name</h>-->
                   ...
                   <div class=" well">
                 <button type="button" class="btn btn-default" data-toggle="collapse" data-target="#demo1">Social Prestige	<span class="badge"></span></button>
			...
			$tempq4="select * from users where local='$value'";
		...
		if($row1 ['user_id']>0)
		{
			...
			if($count>10)
			{
				...
				while($i<10)
				{
					...
					$row=mysqli_fetch_assoc($result);
					echo"<div class='well'>
					<img src='images/bronze medal.png'class='img-square' height='30' alt='Avatar'>$arr_gold[$i]
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="panel panel-default text-left">
            ...
            <form action="polilocalcheck.php" method="post" enctype="multipart/form-data">
     ...
     <img src='images/speakup.png' height='35'/>	SpeakUp
	  ...
	  $conn = mysqli_connect('localhost','root','','poliscope');
        if(mysqli_connect_error())
        {
            ...
            $sql="select * from post as p inner join posts as po on p.const='local' and po.politician_id=$_SESSION[pol] and p.area=po.const order by p.post_id desc";
            $result=mysqli_query($conn,$sql);
				...
				$type = "";
				    ...
				    if(!($row[$no]['image']!=null)&&!($row[$no]['speak']!=null)){
						echo"<div class='col-sm-9'>
							 ...
							 <br><br><br><br>
							 <div class='om'>
							  <form action='polilocaltemp.php?support=true' method='post'>
			...
			<div class='om'>
            <form action='polilocaltemp.php?neutral=true' method='post'>
			...
			<div class='om'>
            <form action='polilocaltemp.php?oppose=true' method='post'>
