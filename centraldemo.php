...
<?php if(isset($_SESSION['user']))
										...
										include 'includes/navbar_central.php';?>
  ...
  <div class="col-sm-4 well">
	...
	$conn = mysqli_connect('localhost','root','','poliscope');
        if(mysqli_connect_error())
        {
			...
			$sql="Select * from users as u inner join posts as p on p.const_category='central' and p.const=(Select central from users where user_id='$_SESSION[user]') and u.user_id=p.user_id";
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="panel panel-default text-left">
            ...
            <form action="centralcheck.php" method="post" enctype="multipart/form-data">
    ...
    <img src='images/speakup.png' height='35'/> SpeakUp
	  ...
	  <input type='file' name="image"  onchange="readURL(this);" style=" padding:8px 10px;color:transparent;"/><br/>
    ...
    <div class='form-group'>
	  ...
	  <img id='blah1' src='#' class="img-square" height="50" width="50" alt='Image' style='margin-left: 10px;'/>
     ...
     <img src='images/speakup.png' height='35'/>	SpeakUp
	  ...
	  $conn = mysqli_connect('localhost','root','','poliscope');
        if(mysqli_connect_error())
        {
            ...
            $sql="select * from post as p inner join users as u on p.const='central' and p.area=u.central and u.user_id='$_SESSION[user]' order by p.post_id desc";
            $result=mysqli_query($conn,$sql);
			$row=mysqli_fetch_all($result,MYSQLI_ASSOC);
			$sql1="Select post_id from post_sup where user_id='$_SESSION[user]'";
				...
				$type = "";
				    ...
				    if(!($row[$no]['image']!=null)&&!($row[$no]['speak']!=null)){
						echo"<div class='col-sm-9'>
							 ...
							 <br><br><br><br>
							 <div class='om'>
							  <form action='centraltemp.php?support=true' method='post'>
			...
			<div class='om'>
            <form action='centraltemp.php?neutral=true' method='post'>
			...
			<div class='om'>
            <form action='centraltemp.php?oppose=true' method='post'>
