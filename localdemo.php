...
<?php if(isset($_SESSION['user']))
										...
										include 'includes/navbar_local.php';?>
  ...
  <div class="col-sm-4 well">
	...
	$conn = mysqli_connect('localhost','root','','poliscope');
        if(mysqli_connect_error())
        {
			...
			$sql="Select * from users as u inner join posts as p on p.const_category='local' and p.const=(Select local from users where user_id=$_SESSION[user]) and u.user_id=p.user_id";
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="panel panel-default text-left">
            ...
            <form action="localcheck.php" method="post" enctype="multipart/form-data">
     ...
     <img src='images/speakup.png' height='35'/>	SpeakUp
	  ...
	  $conn = mysqli_connect('localhost','root','','poliscope');
        if(mysqli_connect_error())
        {
            ...
            $sql="select * from post as p inner join users as u on p.const='local' and p.area=u.local and u.user_id='$_SESSION[user]' order by p.post_id desc";
            $result=mysqli_query($conn,$sql);
				...
				$type = "";
				    ...
				    if(!($row[$no]['image']!=null)&&!($row[$no]['speak']!=null)){
						echo"<div class='col-sm-9'>
							 ...
							 <br><br><br><br>
							 <div class='om'>
							  <form action='localtemp.php?support=true' method='post'>
			...
			<div class='om'>
            <form action='localtemp.php?neutral=true' method='post'>
			...
			<div class='om'>
            <form action='localtemp.php?oppose=true' method='post'>
