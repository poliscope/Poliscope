...
if(mysqli_connect_error())
{
    ...
    if(!empty($_GET["neutral"])){
        ...
        if($checknut==1)
            header("Location:centraldemo.php?checknut=true");
        if($checknut1==1){

            $sql1="UPDATE post_sup set support='n' where post_id='$pid' and user_id='$_SESSION[user]'";

            $sql3="UPDATE post_sup set neutral='y' where post_id='$pid' and user_id='$_SESSION[user]'";
        ...
        if($checknut2==1){
            $sql2="UPDATE post_sup set oppose='n' where post_id='$pid' and user_id='$_SESSION[user]'";
            $sql3="UPDATE post_sup set neutral='y' where post_id='$pid' and user_id='$_SESSION[user]'";
            $sql4="Select * from post where post_id='$pid'";
            $result1=mysqli_query($conn,$sql4);
            $row1=mysqli_fetch_assoc($result1);
        ...
        if($checknut!=1&&$checknut1!=1&&$checknut2!=1){
            $sql2="INSERT INTO post_sup(`post_id`,`user_id`,`support`,`oppose`,`neutral`) VALUES('$pid','$_SESSION[user]','n','n','y')";
            $sql6="UPDATE post set neutral='$nut' where post_id='$pid'";
    ...
    if(!empty($_GET["oppose"])){
        ...
        if($newcheck==1)
            header("Location:centraldemo.php?check=true");
        if($check==1){
            $sql1="UPDATE post_sup set support='n' where post_id='$pid' and user_id='$_SESSION[user]'";
            $sql2="UPDATE post_sup set oppose='y' where post_id='$pid' and user_id='$_SESSION[user]'";
        ...
        if($checknut==1){
            $sql2="UPDATE post_sup set oppose='y' where post_id='$pid' and user_id='$_SESSION[user]'";
            $sql9="UPDATE post_sup set neutral='n' where post_id='$pid' and user_id='$_SESSION[user]'";
            $sql3="Select * from post where post_id='$pid'";
            $result1=mysqli_query($conn,$sql3);
            $row1=mysqli_fetch_assoc($result1);
            $temp1=$row1['neutral'];
        ...
        {
            $sql5="INSERT INTO post_sup(`post_id`,`user_id`,`support`,`oppose`,`neutral`) VALUES('$pid','$_SESSION[user]','n','y','n')";
    ...
    if(!empty($_GET["support"])){
        ...
        if($newcheck1==1)
            header("Location:centraldemo.php?check1=true");
        if($check3==1){
            $sql8="UPDATE post_sup set oppose='n' where post_id='$pid' and user_id='$_SESSION[user]'";
            $sql9="UPDATE post_sup set support='y' where post_id='$pid' and user_id='$_SESSION[user]'";
        ...
        if($checknut==1){
            $sql9="UPDATE post_sup set support='y' where post_id='$pid' and user_id='$_SESSION[user]'";
            $sql88="UPDATE post_sup set neutral='n' where post_id='$pid' and user_id='$_SESSION[user]'";
            $sql10="Select * from post where post_id='$pid'";
            $result3=mysqli_query($conn,$sql10);
            $row3=mysqli_fetch_assoc($result3);
            $temp1=$row3['neutral'];
        ...
        if($newcheck1!=1&&$check3!=1&&$checknut!=1){
            $sql12="INSERT INTO post_sup(`post_id`,`user_id`,`support`,`oppose`,`neutral`) VALUES('$pid','$_SESSION[user]','y','n','n')";
