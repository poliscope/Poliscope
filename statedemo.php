...
<?php if(isset($_SESSION['user']))
										...
										include 'includes/navbar_state.php';?>
  ...
  <div class="col-sm-4 well">
	...
	$conn = mysqli_connect('localhost','root','','poliscope');
        if(mysqli_connect_error())
        {
			...
			$sql="Select * from users as u inner join posts as p on p.const_category='state' and p.const=(Select state_con from users where user_id='$_SESSION[user]') and u.user_id=p.user_id";
    ...
    <!--<img src="bird.jpg"  alt="Avatar">   <h>User name</h>-->
			...
			$tempq4="select * from users where state='$value'";
		...
		if($row1 ['user_id']>0)
		{
			...
			if($count>10)
			{
				...
				while($i<10)
				{
					...
					$row=mysqli_fetch_assoc($result);
					echo"<div class='well'>
					<img src='images/silver medal.png'class='img-square' height='30' alt='Avatar'>$arr_gold[$i]
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="panel panel-default text-left">
            ...
            <form action="statecheck.php" method="post" enctype="multipart/form-data">
     ...
     <img src='images/speakup.png' height='35'/>	SpeakUp
	  ...
	  $conn = mysqli_connect('localhost','root','','poliscope');
        if(mysqli_connect_error())
        {
            ...
            $sql="select * from post as p inner join users as u on p.const='state' and p.area=u.state_con and u.user_id='$_SESSION[user]' order by p.post_id desc";
            $result=mysqli_query($conn,$sql);
				...
				$type = "";
				    ...
				    if(!($row[$no]['image']!=null)&&!($row[$no]['speak']!=null)){
						echo"<div class='col-sm-9'>
							 ...
							 <br><br><br><br>
							 <div class='om'>
							  <form action='statetemp.php?support=true' method='post'>
			...
			<div class='om'>
            <form action='statetemp.php?neutral=true' method='post'>
			...
			<div class='om'>
            <form action='statetemp.php?oppose=true' method='post'>
