...
if(mysqli_connect_error())
{
	...
	$ln=$tmprow['last_name'];
    $sql="INSERT INTO `comment`(`post_id`,`des`,`poli_id`,`modified_time`,`modified_date`,`first`,`last`) VALUES ('$_SESSION[sp]','$des','$_SESSION[pol]',CURRENT_TIME(),CURRENT_DATE(),'$fn','$ln')";
    ...
    if(mysqli_query($conn,$sql)){
        /*if($img===FALSE){
            ...
            //$check=1;
            $sql1 = "UPDATE comment set image=? where poli_id=$_SESSION[pol] and modified_time=CURRENT_TIME() and modified_date=CURRENT_DATE()";
