...
<body>
 ...
 echo"<ul class='pager'>";
    if($_SESSION['page']==1)
    echo"<li class='previous'><a href='homedemo.php'><span class='glyphicon glyphicon-arrow-left'></span>	Back</a></li>
    <br><br>";
	if($_SESSION['page']==2)
    echo"<li class='previous'><a href='localdemo.php'><span class='glyphicon glyphicon-arrow-left'></span>	Back</a></li>
    <br><br>";
	if($_SESSION['page']==3)
    echo"<li class='previous'><a href='statedemo.php'><span class='glyphicon glyphicon-arrow-left'></span>	Back</a></li>
    <br><br>";
	if($_SESSION['page']==4)
    echo"<li class='previous'><a href='centraldemo.php'><span class='glyphicon glyphicon-arrow-left'></span>	Back</a></li>
    <br><br>";
	if($_SESSION['page']==5){
	$id = $_SESSION['comment_sess'];
	echo"<li class='previous'><a href='user.php?id=$id'><span class='glyphicon glyphicon-arrow-left'></span>	Back</a></li>
    <br><br>";
	}
    ...
    <div class='row'>
        <div class='col-sm-7'>
          <div class='panel panel-default text-left'>
			...
			<form action='commentcheck.php' method='post' enctype='multipart/form-data'>
